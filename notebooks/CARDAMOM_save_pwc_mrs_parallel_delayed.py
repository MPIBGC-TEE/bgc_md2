...
def func_chunk(chunk_ds):
    print('\nChunk:', chunk_ds.ens.data[0], '-', chunk_ds.ens.data[-1], '\n')
...
results = []
for index in range(0, 6, chunk_dict['ens']):
...
result = compute(delayed_results, scheduler='processes', num_workers=2, memory_limit="3GB")
#result.visualize()
# -
