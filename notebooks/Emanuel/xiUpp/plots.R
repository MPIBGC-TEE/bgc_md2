...
text(2022,min(TCS)+(difTCS/2), labels=round(difTCS, 1))
dev.off()
...
par(mar=c(4,4,0,0))
plot(bttmeans$Year, bttmeans$meanBTT, type="l",ylim=c(0,25),col=2, xlab="Calendar year", ylab="Backward transit time (yr)", bty="n")
