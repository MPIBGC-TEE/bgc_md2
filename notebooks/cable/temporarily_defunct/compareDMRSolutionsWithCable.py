...
# -
    ...
    out_path = Path('/home/data/cable-data/example_runs/parallel_1901_2004_with_spinup/output/new4')
    zarr_cache_path = out_path.joinpath("zarr")
    sol_from_B_u_x0 = cC.sol_from_B_u_x0(
            zarr_cache_path,
            land_point_patch_combi_slice=sl,
