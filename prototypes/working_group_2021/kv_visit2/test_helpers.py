...
def make_test_args(conf_dict,msh,mvs):
    ...
    epa_opt=msh.EstimatedParameters(
        beta_leaf=0.5904887060961475, 
        beta_wood=0.2696537315365181, 
        T_0=2.0967991338070493, 
        E=3.6865785512582736, 
        KM=10.023011150427664, 
        r_C_leaf_litter_rh=0.0008399506804490531, 
        r_C_wood_litter_rh=0.0012779424269616457, 
        r_C_root_litter_rh=0.0005743309880704742, 
        r_C_soil_fast_rh=0.00012416221939979966, 
        r_C_soil_slow_rh=2.2782309983153434e-05, 
        r_C_soil_passive_rh=2.7058112161701114e-05, 
        r_C_leaf_2_C_leaf_litter=0.023533255514580655, 
        r_C_wood_2_C_wood_litter=0.00012998882042362456, 
        r_C_root_2_C_root_litter=9.085555809541065e-05, 
        r_C_leaf_litter_2_C_soil_fast=0.0016679350646994296, 
        r_C_leaf_litter_2_C_soil_slow=0.00047008836430681493, 
        r_C_leaf_litter_2_C_soil_passive=5.220887201324556e-05, 
        r_C_wood_litter_2_C_soil_fast=9.979877423318034e-06, 
        r_C_wood_litter_2_C_soil_slow=0.00021657308441832675, 
        r_C_wood_litter_2_C_soil_passive=0.00011386992495595078, 
        r_C_root_litter_2_C_soil_fast=0.0002838927904015986, 
        r_C_root_litter_2_C_soil_slow=8.250244613461415e-05, 
        r_C_root_litter_2_C_soil_passive=4.107434980082607e-05, 
        C_leaf_0=0.04704910632144658, 
        C_wood_0=2.471585301570857, 
        C_leaf_litter_0=0.1983362503092279, 
        C_wood_litter_0=0.137365106205411, 
        C_soil_fast_0=2.519953530041826, 
        C_soil_slow_0=4.552716494842766
    )
