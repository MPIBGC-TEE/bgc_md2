...
from yy_cable_symbolic import (
    construct_matrix_func_sym
)
from mm_old_helpers import construct_matrix_func
from general_helpers import respiration_from_compartmental_matrix ,month_2_day_index
...
def plot_solutions(
    ...
    if tup[0].ndim == 1:
        ...
        axs = fig.subplots(n_vars,1)#figsize=(10,n_vars*10))
