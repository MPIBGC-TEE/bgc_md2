...
def spatial_mask(dataPath)->'CoorMask':
    mask=nc.Dataset(dataPath.joinpath("LPX-Bern_S2_cSoil.nc")).variables['cSoil'][0,:,:].mask
...
# def get_global_mean_vars_all(experiment_name="LPX-Bern_S2_"):
    
    # def nc_file_name(nc_var_name, experiment_name="LPX-Bern_S2_"):
        # return experiment_name+"{}.nc".format(nc_var_name)

    # def nc_global_mean_file_name(nc_var_name, experiment_name="LPX-Bern_S2_"):
    ...
    # conf_dict = gh.confDict("LPX-Bern")
    ...
    # else:
        ...
        # template = nc.Dataset(dataPath.joinpath("LPX-Bern_S2_cSoil.nc")).variables['cSoil'][0,:,:].mask
        # gcm=gh.project_2(
                # source=gm,
                # target=gh.CoordMask(
