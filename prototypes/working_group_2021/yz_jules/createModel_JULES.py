...
cpa = msh.Constants(  # use Constants namedtuple to define constant values #Define the constant values of parameters NOT affected by data assimilation
    npp_0=dvs.npp[0],
    rh_0=svs_0.rh,
    c_veg_0=svs_0.cVeg,
...
def xi_maker(tsl, Mw, mrso, landCoverFrac): # check the mrso unit here!!, in kg m-2
    def xi_func( day):
