...
def epa_0(
    ...
    # does not do anything here (but in other schemes where epa_0 depends
    # on other values and can not be solely set by a file
...
def epa_min(
    ...
    # does not do anything here (but in other schemes where epa_min depends
    # on other values and can not be solely set by a file
    depa = DerivedEstimatedParameters()
    return EstimatedParameters(*fepa,*depa)
...
def epa_max(
    ...
    # does not do anything here (but in other schemes where epa_max depends
    # on other values and can not be solely set by a file
    depa = DerivedEstimatedParameters()
    return EstimatedParameters(*fepa,*depa)
