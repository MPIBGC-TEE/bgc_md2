...
def spatial_mask(dataPath)->'CoorMask':
    mask=nc.Dataset(dataPath.joinpath("ISBA-CTRIP_S2_cSoil.nc")).variables['cSoil'][0,:,:].mask
...
def make_model_index_transforms():
    ...
    lat_0 = -59.5, ### this does not cover full globe, but excludes Antarctica from the grid extent
    lon_0 = -179.5,
    step_lat = 1,
    step_lon = 1,
 )
