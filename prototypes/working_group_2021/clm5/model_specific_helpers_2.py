...
def spatial_mask(dataPath)->'CoorMask':
    mask=nc.Dataset(dataPath.joinpath("CLM5.0_S2_cSoil.nc")).variables['cSoil'][0,:,:].mask
...
# def make_model_index_transforms():
    ...
    # lat_0 = -90,
    # lon_0 = 0,
    # step_lat = 0.9424083769633508,#0.9375,
    # step_lon = 1.25,
 # )
...
def make_model_index_transforms():
    ...
    lat_0 = -90
    lon_0 = 0
    step_lat=0.9424083769633508 #special case n.e. 180/nlatssince clm5 includes -90 and 90
...
def get_global_mean_vars_all(experiment_name):
        return(
            gh.get_global_mean_vars_all(model_folder="clm5", 
...
# def get_global_mean_vars_all(experiment_name="CLM5_S2_"):
    
    # def nc_file_name(nc_var_name, experiment_name="CLM5_S2_"):
        # return experiment_name+"{}.nc".format(nc_var_name)

    # def nc_global_mean_file_name(nc_var_name, experiment_name="CLM5_S2_"):
    ...
    # else:
        ...
        # template = nc.Dataset(dataPath.joinpath("CLM5.0_S2_cSoil.nc")).variables['cSoil'][0,:,:].mask
        # gcm=gh.project_2(
                # source=gm,
                # target=gh.CoordMask(
