...
def get_global_mean_vars_all(experiment_name):
        return(
            gh.get_global_mean_vars_all(model_folder="ORCHIDEEv3", 
...
# def get_global_mean_vars_all(experiment_name="ORCHIDEEv3_S2_"):
    
    # def nc_file_name(nc_var_name, experiment_name="ORCHIDEEv3_S2_"):
        # return experiment_name+"{}.nc".format(nc_var_name)

    # def nc_global_mean_file_name(nc_var_name, experiment_name="ORCHIDEEv3_S2_"):
    ...
    # conf_dict = gh.confDict("ORCHIDEEv3")
    ...
    # else:
        ...
        # template = nc.Dataset(dataPath.joinpath("ORCHIDEEv3_S2_cSoil.nc")).variables['cSoil'][0,:,:].mask
        # gcm=gh.project_2(
                # source=gm,
                # target=gh.CoordMask(
