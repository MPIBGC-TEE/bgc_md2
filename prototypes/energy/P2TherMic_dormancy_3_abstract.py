...
sym_dict={
    ...
    "S_S": "concentration of substrate in Soil [mol g^{-1}]",
    "rho_B" : "",
    "Theta": "",
    ...
    "r_d": "microbial growth dormant [mol g^{-1} s^{-1}]", # fixme mm ???
    "Phi": "",
    "Y_X_S": "",
    "Y_X_N": "", 
    ...
    "H_NH3":  "",
    "mu_max": "",
    "f_d": "Mass transfer rate soil-> microbial cells, reversible diffusion"
...
rhs_sym=Tuple(
        r_d*(S_S*rho_B/Theta - S)- (R*r_X +  r_M),
        -r_d * (S_S * rho_B / Theta - S),
