...
!         DelIntercept = .FALSE.,& ! 38 change in interception storage [kg/m2]
         ...
         RootResp = .FALSE.,& ! 50 heterotrophic respiration [umol/m2/s]
         ...
         Nsoilmin = .FALSE.,& ! 50 Soil mineral N [gN/m2]
         Nsnet = .FALSE.,& ! 50 net N mineralisation [gN/m2/day]
         Nmindep = .FALSE.,& ! 50 N deposition [gN/m2/day]
         Nminfix = .FALSE.,& ! 50 N fixation [gN/m2/day]
         Nminloss = .FALSE.,& ! 50 N loss [gN/m2/day]
         Nminleach = .FALSE.,& ! 50 N leaching [gN/m2/day]
         Nupland = .FALSE.,& ! 50 vegetation N uptake [gN/m2/day]
