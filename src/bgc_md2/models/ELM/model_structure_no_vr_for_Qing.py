def load_model_structure_with_vegetation():
    ...
    # "pool_name" is just an arbitrary choice
    # "stock_var" means the variable name in the netCDF dataset
    pool_structure = [
    ...
    external_input_structure = {
        # pool_name: list of associated flux variables in the netcdf dataset
    ...
    # in the vertically aggregated model there are no vertical fluxes
    vertical_structure = {}
