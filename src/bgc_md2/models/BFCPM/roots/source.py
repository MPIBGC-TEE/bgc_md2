...
from .. import B_R, C_R, GPP, GR, MR, S_R, C_gR, E, delta_R, eta_R, f_R, t
...
roots = (roots_sv_set, roots_in_fluxes, roots_out_fluxes, roots_internal_fluxes)

srm = SmoothReservoirModel.from_state_variable_indexed_fluxes(
    Matrix([E, B_R, C_R]), t, roots_in_fluxes, roots_out_fluxes, roots_internal_fluxes
)
