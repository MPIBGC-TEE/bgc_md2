...
from .. import (B_OH, B_OS, B_TS, C_S, GPP, MS, S_O, C_gHW, C_gW, E,
                G_OS_from_CS, G_OS_from_E, delta_W, eta_W, f_CS, f_O, t, v_O,
                zeta_dw, zeta_gluc)

# "other" means branches + coarse roots
other_sv_set = set([E, C_S, B_OS, B_OH, G_OS_from_CS])
...
other = (other_sv_set, other_in_fluxes, other_out_fluxes, other_internal_fluxes)
