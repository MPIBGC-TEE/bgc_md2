...
class TestModelStructure(unittest.TestCase):
    def setUp(self):
        ...
        external_input_structure = {
            ...
            "Litter 1": [
                "gap_mortality_c_to_litr_met_c_col",
    ...
    def test_get_flux_var_names(self):
        self.assertEqual(
            self.ms.get_flux_var_names()[7], "gap_mortality_c_to_litr_cel_c_col"
        )
    ...
    def test_get_stock_var(self):
        self.assertEqual(self.ms.get_stock_var("CWD"), "CWDC_vr")
    ...
    def test_get_external_input_flux_var(self):
        ...
        self.assertEqual(self.ms.get_external_input_flux_var("CWD"), ref)

    def test_get_external_output_flux_var(self):
        ref = ["CWD_HR_L2_vr", "CWD_HR_L3_vr"]
        self.assertEqual(self.ms.get_external_output_flux_var("CWD"), ref)

    def test_get_horizontal_flux_var(self):
        self.assertEqual(
            self.ms.get_horizontal_flux_var("CWD", "Litter 2"), "CWDC_TO_LITR2C_vr"
        )
