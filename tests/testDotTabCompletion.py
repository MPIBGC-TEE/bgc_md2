...
from bgc_md2.models.helpers import computable_mvars, get_single_mvar_value
...
modelName = "testVectorFree"
meth_dict = {
    "get_" + var.__name__: funcMaker(var, modelName)
    for var in computable_mvars(modelName)
}
