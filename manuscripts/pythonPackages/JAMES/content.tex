...
fulfill all of these criteria.%: \enumref{enum:function}, \enumref{enum:general} and \enumref{enum:measurable}.
...
prohibitively expensive.  We created examples to teach new users how use the
