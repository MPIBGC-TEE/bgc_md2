...
between them. \hmm{Why are they intransparent?} The scientific challenge is to find the common
...
other.  
We provide an extensible, declarative domain specific language (DSL) to enable (database) queries and reduce the amount of model specific code by orders of magnitude, avoiding duplication in two novel ways: It \hmm{What is ``It''?} defines an extensible set of 
