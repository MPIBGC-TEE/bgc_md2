...
from ModelDataObject import ModelDataObject, \
...
#    dataset         = parameter_set['dataset']
    ...
    external_output_structure_14C = {
        'CWD':      ['C14_CWD_HR_L2_vr', 
                     'C14_CWD_HR_L3_vr',
                     'C14_M_CWDC_TO_FIRE_vr'],
        ...
        'Soil 1':   ['C14_SOIL1_HR_S2_vr',
                     'C14_SOIL1_HR_S3_vr'],
        'Soil 2':   ['C14_SOIL2_HR_S1_vr',
                     'C14_SOIL2_HR_S3_vr'],
...
def load_model_12C_data(parameter_set, location):
    ...
    try:
        ...
        xs_12C = mdo_12C.load_stocks(
            func       = getStockVariable_from_Density,
            lat_arr    = [lat_index],
            lon_arr    = [lon_index],
            data_shift = 0
        ).data[:,0,0,...].ravel().tolist()

        us_12C = mdo_12C.load_external_input_fluxes(
        ...
        rs_12C = mdo_12C.load_external_output_fluxes(
            func       = getFluxVariable_from_DensityRate,
            lat_arr    = [lat_index], 
            lon_arr    = [lon_index], 
            data_shift = 1 
...
def load_model_14C_data(parameter_set, location):
    ...
    try:
        ...
        us_14C = mdo_14C.load_external_input_fluxes(
            func           = getFluxVariable_from_DensityRate,
            lat_arr        = [lat_index], 
            lon_arr        = [lon_index], 
            data_shift     = 1 
        ...
        rs_14C = mdo_14C.load_external_output_fluxes(
            func           = getFluxVariable_from_DensityRate,
            lat_arr        = [lat_index], 
            lon_arr        = [lon_index], 
            data_shift     = 1 
