...
!           DelIntercept = (/-100.0,100.0/),    &
           ...
           Nsoilmin = (/0.0,100000.0/),        & ! gN/m2
           Nsnet = (/0.0,100000.0/),        & ! gN/m2/day
           Nmindep = (/0.0,100000.0/),        & ! gN/m2/day
           Nminfix = (/0.0,100000.0/),        & ! gN/m2/day
           Nminloss = (/0.0,100000.0/),        & ! gN/m2/day
           Nminleach = (/0.0,100000.0/),        & ! gN/m2/day
           Nupland = (/0.0,100000.0/),        & ! gN/m2/day
           Cplant  = (/-10,100000/),           &
           Csoil   = (/-10,100000/),           &
           Clitter = (/-10,100000/),           &
           Nplant = (/-10,1000/),              &
