...
! .............................................................................
   ...
   TYPE canopy_type
      ...
      REAL, DIMENSION(:), POINTER ::                                           &
         ...
         cisun,   & ! intercellular CO2 concentration
         cisha,   & ! intercellular CO2 concentration
         cx1sun,  & ! enzyme kinetics
         cx1sha,  & ! enzyme kinetics
         cx2sun,  & ! CO2 compensation point 
         cx2sha     ! CO2 compensation point 
...
SUBROUTINE alloc_canopy_type(var, mp)
   ...
   ALLOCATE( var% cisun(mp) )  
   ALLOCATE( var% cx1sun(mp) )  
   ALLOCATE( var% cx2sun(mp) )  
   ALLOCATE( var% cisha(mp) )  
   ALLOCATE( var% cx1sha(mp) )  
   ALLOCATE( var% cx2sha(mp) )  
...
SUBROUTINE dealloc_canopy_type(var)
   ...
   DEALLOCATE( var% gswx )  
   DEALLOCATE( var% cisun )  
   DEALLOCATE( var% cx1sun )  
   DEALLOCATE( var% cx2sun )  
   DEALLOCATE( var% cisha )  
   DEALLOCATE( var% cx1sha )  
   DEALLOCATE( var% cx2sha )  
