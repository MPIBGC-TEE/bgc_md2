...
def draw_update_sequence(computers,max_it,fig,mvar_aliases=frozendict({}),computer_aliases=frozendict({})):
    ...
    for i in range(nr):
        draw_ComputerSetMultiDiGraph_matplotlib(axs[i],lg[i],mvar_aliases,computer_aliases,pos=pos)
